...
import be.noah.ritual_magic.blocks.entity.RitualPedestalBlockEntity;
...
public class RitualPedestalBlockEntityRenderer implements BlockEntityRenderer<RitualPedestalBlockEntity> {
    @Override
    public void render(RitualPedestalBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
