...
public enum ModArmorMaterials implements ArmorMaterial {
    DWARVEN_STEEL("dwarven_steel", 64, new int[]{ 5, 7, 5, 4 }, 12,
            SoundEvents.ARMOR_EQUIP_IRON, 7f, 1f, () -> Ingredient.of(ModItems.DWARVEN_STEEL_INGOT.get())),
    ...
    PURE_NETHERITE("pure_netherite", 50, new int[]{ 5, 7, 5, 4 }, 32,
            SoundEvents.ARMOR_EQUIP_IRON, 5f, 0.3f, () -> Ingredient.of(ModItems.DWARVEN_STEEL_INGOT.get())),
    DRAGON_SCALE("dragon_scale", 40, new int[]{ 5, 7, 5, 4 }, 32,
            SoundEvents.ARMOR_EQUIP_IRON, 3f, 0f, () -> Ingredient.of(ModItems.DRAGON_PLATE.get()));
