...
import be.noah.ritual_magic.item.ModToolTiers;
...
public class ArmorPlate extends TieredItem {
    ...
    private int getElementalAffinity(ItemStack stack) {return stack.hasTag() ? stack.getTag().getInt(ELEMENTAL_AFFINITY) : 0;}
    private void setTElementalAffinity(ItemStack stack, int value) {stack.getOrCreateTag().putInt(ELEMENTAL_AFFINITY, value);}
