...
public class BallLightningRenderer extends EntityRenderer<BallLightning> {
    ...
    public BallLightningRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }
    ...
    public void render(BallLightning projectile, float p_114081_, float partialTick, PoseStack stack, MultiBufferSource source, int light)
    {
        stack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(BallLightning p_114482_)
    {
